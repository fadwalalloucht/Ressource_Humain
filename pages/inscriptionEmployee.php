...
<body>
   <div class="container">
      ...
      <div class="content">
         <form enctype="multipart/form-data" method="post" action="addEmployee.php">
            <div class="user-details">
               ...
               <div class="input-box">
                  ...
                  <input type="date"  name="dateNaiss" placeholder=""  id="" required>
               </div>
               ...
               <div class="input-box">
                  ...
                  <input type="text" name="poste" placeholder="Entrer votre Poste" id="poste" required>
               </div>
               <div class="input-box">
                  <span class="details">Departement</span>
                  <input type="text" name="deparetemant" placeholder="Entrer votre Departement"  id="departement" required>
               </div>
               <div class="input-box">
